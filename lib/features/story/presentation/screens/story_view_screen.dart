...
class StoryViewScreen extends StatefulWidget {
  // stories is going to contain the id of all the stories that have been uploaded
...
class _StoryViewScreenState extends State<StoryViewScreen> {
  ...
  void initState() {
    ...
    for (final story in widget.stories) {
      final storyView = StoryItem(StoryDetailScreen(story: story),
  ...
  Widget build(BuildContext context) {
    // the story items take in the storyItems from the user and the controller
    return StoryView(
...
class _StoryDetailScreenState extends ConsumerState<StoryDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // to be put at the center of the screen
          Center(
            child: SizedBox(
